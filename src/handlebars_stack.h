...
struct handlebars_stack * handlebars_stack_ctor(struct handlebars_context * ctx) HBS_ATTR_RETURNS_NONNULL;
void handlebars_stack_dtor(struct handlebars_stack * stack);
size_t handlebars_stack_length(struct handlebars_stack * stack);

struct handlebars_value * handlebars_stack_push(struct handlebars_stack * stack, struct handlebars_value * value) HBS_ATTR_RETURNS_NONNULL;
...
struct handlebars_value * handlebars_stack_set(struct handlebars_stack * stack, size_t offset, struct handlebars_value * value) HBS_ATTR_RETURNS_NONNULL;
void handlebars_stack_reverse(struct handlebars_stack * stack);

void * handlebars_stack_push_ptr(struct handlebars_stack * stack, void * value) HBS_ATTR_RETURNS_NONNULL;
